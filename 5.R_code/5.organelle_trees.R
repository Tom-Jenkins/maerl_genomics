...
# Combine ggplots
library(ggpubr)
figS7 = ggarrange(tree1, tree2, nrow = 2)
annotate_figure(figS7,
                top = text_grob("Hierarchical clustering using Tamura and Nei (1993) genetic distances\n",
                                face = "bold", size = 20))
ggsave(plot = figS7, "./Figures/FigureS7.png", width = 15, height = 10, dpi = 600)
ggsave(plot = figS7, "./Figures/FigureS7.pdf", width = 15, height = 10)
...
# Combine ggplots
library(ggpubr)
figS8 = ggarrange(tree3, tree4, nrow = 2)
annotate_figure(figS8,
                top = text_grob("Hierarchical clustering using Tamura and Nei (1993) genetic distances\n",
                                face = "bold", size = 20))
figS8
ggsave(plot = figS8, "./Figures/FigureS8.png", width = 15, height = 10, dpi = 600)
ggsave(plot = figS8, "./Figures/FigureS8.pdf", width = 15, height = 10)
